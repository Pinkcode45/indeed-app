            ...
            <div className='p-4 md:px-[8rem]'>
                <div>
                    ...
                    <div className='flex items-center gap-6'>
                        <Link  href="" className='font-bold hover:bg-blue-100 hover:text-blue-500 p-4 '>
                            <div>
                ...
                <div>
                    ...
                    <div id='' className='flex items-center justify-center ' >
                        <div>
                            ...
                            <div className=''>
                                <Link href=''><button className='font-bold text-[#2557a7] pb-8'>Not seen a job?</button> <br/></Link>
                                <Link href=''><button className='bg-[#2557a7] py-2 px-8  text-white rounded-lg font-bold'>Find job</button></Link>
                            </div>
                        </div>
                    </div>
                ...
                <div>
                    ...
                    <div id='' className='flex items-center justify-center' >
                        <div>
                            ...
                            <div className=''>
                                <Link href=''><button className='font-bold text-[#2557a7] pb-8'>Not seen an application?</button> <br/></Link>
                                <Link href=''><button className='bg-[#2557a7] py-2 px-8  text-white rounded-lg font-bold'>Find job</button></Link>
                            </div>
                        </div>
                    </div>
                ...
                <div>
                    ...
                    <div id='' className='flex items-center justify-center' >
                        <div>
                            ...
                            <div className=''>
                                <Link href=''><button className='font-bold text-[#2557a7] pb-8'>Not seen an interview?</button> <br/></Link>
                                <Link href=''><button className='bg-[#2557a7] py-2 px-8  text-white rounded-lg font-bold'>Find job</button></Link>
                            </div>
                        </div>
                    </div>
                    ...
                    <div id='' className='flex items-center justify-center' >
                        <div>
                            ...
                            <div className=''>
                                ...
                                <Link href=''><button className='bg-[#2557a7] py-2 px-8  text-white rounded-lg font-bold'>Reload the page</button></Link>
                            </div>
                        </div>
                    </div>
