        ...
        <div className='flex items-center justify-center'>
          <div>
            ...
            <div className='flex gap-6 md:mt-10'>
              <Link href='' className='hover:font-bold hover:text-[#2557a7] hover:bg-blue-100'>
          ...
          <div>
            ...
            <div className='flex items-center justify-center'>
              <div >
                ...
                <Link href=''><button className='bg-[#2557a7] py-2 px-8  text-white rounded-lg font-bold'>Write a review</button></Link>
              </div>
            </div>
          </div>
        </div>
