                ...
                <div className='md:border-[1px]  md:mt-[-25rem] bg-white md:w-[1200px] rounded-sm '>
                    <div className='flex items-center justify-center p-10'>
                        <div className='grid md:grid-cols-2'>
                            ...
                            <div className='flex flex-col-2 gap-6 mb-[6rem]'>
                                <Image src='/pin 1.PNG' alt=''
                                 width={80}
                                height={100}
                              />
                                <div className='w-[350px]'>
                                     <h2 className='font-bold text-2xl mb-4'>Get more visibility</h2>
                                    <p className='text-[#2557A7] font-semibold'><Link href="">Sponsor your job</Link> <span className='text-black font-light'>to ensure it gets seen by the right people</span></p>
                                </div>
                
                
                            </div>
                            <div className='flex flex-col-2 gap-6 mb-[6rem]'>
                                <Image src='/pin2.PNG' alt=''
                                 width={90}
                                height={100}
                              />
                                <div className='w-[350px]'>
                    ...
                    <div className='flex flex-col mr-6 md:flex-row items-center justify-center'>
                        ...
                        <div className='ml-[10rem] md:ml-[2px] mt-6 md:mt-[-6px]'>
                            <p className=''>You control your posts 24/7—edit, add, pause, or close them whenever you want.<Link href=""><span       className='font-bold text-blue-600'>Learn more about posting</span></Link></p>
                        </div>
                    </div>
